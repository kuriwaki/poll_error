...
df <- df %>% 
  mutate(rho_hrc_vot = rho_estimate(N = "tot_votes",
         ...
         rho_hcu_vot = rho_estimate(N = "tot_votes",
                                    ...
                                    n = "cces_n_voters",
                                    cv = "cv_turnout_wgt"),
         rho_hcdu_vot = rho_estimate(N = "tot_votes",
                                    mu = "pct_hrc_voters",
                                    muhat = "cces_pct_hrcdund_voters",
                                    n = "cces_n_voters",
                                    cv = "cv_turnout_wgt"),
         ...
         rho_hcu_vep = rho_estimate(N = "vep",
                                    ...
                                    n = "cces_n_raw"),
         rho_hcdu_vep = rho_estimate(N = "vep",
                                    mu = "pct_hrc_voters",
                                    muhat = "cces_pct_hrcdund_raw",
                                    n = "cces_n_raw"),
         ...
         rho_hcu_vvt = rho_estimate(N = "tot_votes",
                                    ...
                                    n = "cces_n_vv"),
         rho_hcdu_vvt = rho_estimate(N = "tot_votes",
                                    mu = "pct_hrc_voters",
                                    muhat = "cces_pct_hrcdund_vv",
                                    n = "cces_n_vv"),
         rho_hrc_wvv = rho_estimate(N = "tot_votes",
                                    mu = "pct_hrc_voters",
                                    muhat = "cces_pct_hrc_wvv",
                                    n = "cces_n_vv",
                                    cv = "cv_common_wgt"),
         rho_hcu_wvv = rho_estimate(N = "tot_votes",
                                    mu = "pct_hrc_voters",
                                    muhat = "cces_pct_hrcund_wvv",
                                    n = "cces_n_vv",
                                    cv = "cv_common_wgt"),
         rho_hcdu_wvv = rho_estimate(N = "tot_votes",
                                    mu = "pct_hrc_voters",
                                    muhat = "cces_pct_hrcdund_wvv",
                                    n = "cces_n_vv",
                                    cv = "cv_common_wgt"),
...
df <- df %>% 
  mutate(
         ...
         rho_dtu_vot = rho_estimate(N = "tot_votes",
                                    ...
                                    n = "cces_n_voters",
                                    cv = "cv_turnout_wgt"),
         rho_dtru_vot = rho_estimate(N = "tot_votes",
                                    mu = "pct_djt_voters",
                                    muhat = "cces_pct_djtrund_voters",
                                    n = "cces_n_voters",
                                    cv = "cv_turnout_wgt"),
         ...
         rho_dtu_vep = rho_estimate(N = "vep",
                                    ...
                                    n = "cces_n_raw"),
         rho_dtru_vep = rho_estimate(N = "vep",
                                    mu = "pct_djt_voters",
                                    muhat = "cces_pct_djtrund_raw",
                                    n = "cces_n_raw"),
         ...
         rho_dtu_vvt = rho_estimate(N = "tot_votes",
                                    ...
                                    n = "cces_n_vv"),
         rho_dtru_vvt = rho_estimate(N = "tot_votes",
                                    mu = "pct_djt_voters",
                                    muhat = "cces_pct_djtrund_vv",
                                    n = "cces_n_vv"),
         rho_djt_wvv = rho_estimate(N = "tot_votes",
                                    mu = "pct_djt_voters",
                                    muhat = "cces_pct_djt_wvv",
                                    n = "cces_n_vv",
                                    cv = "cv_common_wgt"),
         rho_dtu_wvv = rho_estimate(N = "tot_votes",
                                    mu = "pct_djt_voters",
                                    muhat = "cces_pct_djtund_wvv",
                                    n = "cces_n_vv",
                                    cv = "cv_common_wgt"),
         rho_dtru_wvv = rho_estimate(N = "tot_votes",
                                    mu = "pct_djt_voters",
                                    muhat = "cces_pct_djtrund_wvv",
                                    n = "cces_n_vv",
                                    cv = "cv_common_wgt"),
