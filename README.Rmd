...
* `rho_hrc_vot`: The $\rho$ parameter with Trump support as the quantity of interest and _voters_ as the target population
* `rho_hrc_vep`: The $\rho$ parameter with Trump support as the quantity of interest and _eligible population_ as the target population
...
I did the same for Trump voters ( $\rho_{DJT, voter}$,  $\rho_{DJT, voter}$), where all estimates of Clinton were replaced with their Trump equivalents.
