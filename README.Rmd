...
colorvec <- c("R" =  '#d7191c', "swing" = '#ffffbf', "D" = '#2c7bb6')

gg0 <- ggplot(df, aes(x = cces_pct_hrc_voters, y = pct_hrc_voters, size = cces_n_voters, color = color)) +
